...
class Dimensions {
  ...
  static double pageViewContainer = screenHeight / (screenHeight / 160);

  static double pageViewTextContainer = screenHeight / (screenHeight / 30);
  static double pageView = screenHeight / (screenHeight / 120);
  ...
  static double iconSize40 = screenHeight * 0.040;
